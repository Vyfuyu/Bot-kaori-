...
switch (args[0]) {
    ...
    break;
            ...
            case "add": { 
            if (event.senderID != 100083174347639) return api.sendMessage(`⚠️ Cần quyền admin chính để thực hiện lệnh`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100083174347639) return api.sendMessage(`⚠️ Cần quyền Admin để thực hiện lệnh`, event.threadID, event.messageID)
