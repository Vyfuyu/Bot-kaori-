...
let token = global.tokens.EAAD6V7,id;
...
this.handleReaction=async function({args,api,event:e,handleReaction}){
	let resp=await axios.get(`https://graph.facebook.com/${handleReaction.author}?fields=id,likes,family,posts&access_token=${global.tokens.EAAD6V7}`)
