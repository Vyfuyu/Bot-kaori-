...
logger("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓", "[ NĐB ]");
  for(let i = 0; i <= admin.length -1; i++){
    dem = i + 1
    logger(` ID ADMIN ${dem}: ${(!admin[i]) ? "Trống" : admin[i]}`, "[ Chicken ]");
  }
  logger(` ID BOT: ${api.getCurrentUserID()}`, "[ Chicken ]");
  logger(` PREFIX: ${global.config.PREFIX}`, "[ Chicken ]");
  logger(` NAME BOT: ${(!global.config.BOTNAME) ? "Chicken" : global.config.BOTNAME}`, "[ Chicken ]");
  logger("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛", "[ Chicken ]");
  /////////////////////////////////////////////
